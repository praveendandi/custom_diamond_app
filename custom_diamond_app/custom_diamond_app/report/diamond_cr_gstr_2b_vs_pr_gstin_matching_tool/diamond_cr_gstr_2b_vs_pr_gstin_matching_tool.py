...
class MatchingTool(object):
	...
	def get_data(self):
		...
		if self.filters['view_type'] == 'Supplier View':
			...
			gstr2b_entries = frappe.db.get_all('CD GSTR 2B Entry', filters= gstr2b_conditions, fields =['cf_party_gstin','cf_party', 'cf_tax_amount', 'cf_purchase_invoice', 'cf_status','cf_trade_name'])
			...
			for entry in gstr2b_entries:
				...
				'supplier_name':entry['cf_trade_name'],
